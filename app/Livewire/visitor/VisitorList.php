...
{
    public  $name, $course_name, $amount, $mobile, $address, $email, $visitor_comment, $gender, $ref_name, $admission_booth_name,$admission_booth_number, $calling_person, $comments, $counseling, $status, $callCount, $isModal = false, $course = [], $councile = [], 
    $callingperson = [], $admissionBooth = [], $sure_id, $visitor_id, $delete_id, $call_count, $sortColumn, $perpage = 30, $search= '';
    protected $listeners = [
