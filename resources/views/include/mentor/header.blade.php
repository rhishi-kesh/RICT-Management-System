            ...
            <div class="flex items-center space-x-1.5 ml-auto dark:text-[#d0d2d6] sm:flex-1 sm:ml-0 lg:space-x-2" >
                ...
                <div class="dropdown flex-shrink-0" x-data="dropdown" @click.outside="open = false">
                    <a href="javascript:;" class="group relative" @click="toggle()">
                        <span >
                            <img class="h-9 w-9 rounded-full object-cover saturate-50 group-hover:saturate-100" src="{{ empty(Auth::guard('mentor')->user()->image) ? url('profile.jpeg') : asset('storage/' . Auth::guard('mentor')->user()->image) }}" width="100px" height="100px" alt="image" />
                        </span>
                    </a>
                    <ul
                        x-cloak
                    ...
                    >
                        <li>
                            <div class="flex items-center px-4 py-4">
                                <div class="flex-none">
                                    <img class="h-10 w-10 rounded-md object-cover" src="{{ empty(auth()->guard('mentor')->user()->image) ? url('profile.jpeg') : asset('storage/' . auth()->guard('mentor')->user()->image) }}" width="100px" height="100px"  alt="image" />
                                </div>
                        ...
                        <li>
                            <a href="{{ route('mentorProfile') }}" class="dark:hover:text-white" @click="toggle">
                                <svg class="h-4.5 w-4.5 shrink-0 mr-2" width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
