            ...
            <li class="nav-item">
                <a href="{{ route('studentsList') }}" class="group sidebargroup">
                    <div class="flex items-center">
                        ...
                        <span
                            class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Students-list</span>
                    </div>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{ route('mentorsList') }}" class="group sidebargroup">
                    <div class="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"
            ...
            <li class="nav-item">
                <a href="{{ route('visitor') }}" class="group sidebargroup">
                    <div class="flex items-center">
                        ...
                        <span
                            class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Visitor List</span>
                    </div>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{ route('counciling') }}" class="group sidebargroup">
                    <div class="flex items-center">
                        ...
                        <span
                            class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Counciling</span>
                    </div>
                </a>
            </li>
            {{-- pay roll --}}
