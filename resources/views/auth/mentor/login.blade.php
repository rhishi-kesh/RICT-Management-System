            ...
            <div class="px-2 sm:px-16 w-full flex items-center justify-center">
                <div class="relative w-full md:w-2/4 rounded-md p-2 bg-gray-200 px-2 md:px-6 py-10">
                    <div class="px-4 md:px-10">
                        <div class="mb-10">
                            <h1 class="text-3xl font-extrabold uppercase !leading-snug text-primary md:text-4xl text-blue-500">Sign in</h1>
                        ...
                        @enderror
                        <form class="space-y-5" method="POST" action="{{ route('mentorPost') }}">
                            @csrf
                            <div>
                                <label for="email">Email</label>
                                <div class="relative">
                                    <input id="email" type="email" placeholder="Enter Email"  class="ps-10 login-form-input bg-white focus:border-blue-500" name="email" value="{{ old('email') }}" />
                        ...
                        <a href="{{ route('mentor.forgotPassword') }}" class="mt-2 inline-block hover:underline text-black text-xl">Forgotten password?</a>
                    </div>
                </div>
            </div>
        </div>
