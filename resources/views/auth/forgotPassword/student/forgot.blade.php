    ...
    <div class="px-2 sm:px-16 w-full flex items-center justify-center">
        <div class="relative w-full md:w-2/4 rounded-md p-2 bg-gray-200 px-2 md:px-6 py-10">
            <div class="px-4 md:px-10">
                <div class="mb-10">
                    <h1 class="text-3xl font-extrabold uppercase !leading-snug text-primary md:text-4xl my-color-blue">Find Your Account</h1>
                ...
                <form action="{{ route('student.forgotPasswordPost') }}" class="space-y-5" method="POST">
                    ...
                    <div>
                        <div class="relative">
                            <input id="email" type="email" placeholder="Enter your email" class="ps-10 login-form-input bg-white focus:border-blue-700" name="email" value="{{ old('email') }}" />
