    ...
    <div class="px-2 sm:px-16 w-full flex items-center justify-center">
        <div class="relative w-full md:w-2/4 rounded-md p-2 bg-gray-200 px-2 md:px-6 py-10">
            <div class="px-4 md:px-10">
                ...
                <form action="{{ route('admin.forgotPasswordPost') }}" class="space-y-5" method="POST">
                    @csrf
                    <div>
                        <div class="relative">
                ...
                <a href="{{ route('login') }}" class="mt-2 inline-block hover:underline text-black text-xl">Sign in</a>
            </div>
        </div>
    </div>
</body>
