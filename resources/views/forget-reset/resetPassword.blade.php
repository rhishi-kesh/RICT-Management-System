            ...
            <div class="px-4 md:px-10">
                <div class="mb-10">
                    <h1 class="text-3xl font-extrabold uppercase !leading-snug text-primary md:text-4xl my-color-blue">
                        Reset password </h1>
                    <p class="text-base font-bold">Enter your email and password to reset</p>
                </div>
                @error('email')
                    <div class="p-2 rounded bg-red-500 text-white">{{ $message }}</div>
                @enderror
                
                <form action="{{ route('resetPassword') }}" class="space-y-5" method="POST">
                    @csrf
                    <input type="hidden" name="id" value="{{ $user[0]['id'] }}">
                    <div>
                        <label for="email">Email</label>
                        <div class="relative">
                            <input id="email" type="text" placeholder="Enter User ID"
                    ...
                    <div>
                        ...
                        <div class="relative text-white-dark">
                            <input id="Password" type="password" placeholder="Enter Password"
                                class="login-form-input ps-10 placeholder:text-white-dark  focus:border-blue-700"
                                name="password" />
                            <span class="absolute start-4 top-1/2 -translate-y-1/2">
                                <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                                    <path opacity="0.5"
                    ...
                    <div>
                        ...
                        <div class="relative text-white-dark">
                            <input id="confirm_password" type="password" placeholder="Enter confirm password"
                                class="login-form-input ps-10 placeholder:text-white-dark  focus:border-blue-700"
