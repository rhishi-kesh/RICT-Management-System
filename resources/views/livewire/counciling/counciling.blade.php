<div class="pt-5" x-data="modal">
    ...
    <div class="mb-3">
        <button @click="toggle; $wire.call('showModal')" class="bg-blue-500 btn text-white border-0 flex items-center justify-between">
            ...
            Add Counciling Person
        </button>
    </div>
    <div class="bg-white dark:bg-slate-900 shadow-md rounded px-4 md:px-8 pt-6 pb-8 mb-4 w-full">
        <h2 class="mb-2 font-bold text-3xl dark:text-white text-blue-500">Counciling persons</h2>
        <hr>
        <div>
            {{-- Show Data --}}
                ...
                <table class="w-full">
                    <thead>
                        <tr>
                            ...
                            <th class="p-3 bg-gray-100 dark:bg-gray-800 text-center">Person Name</th>
            ...
            <div class="livewire-pagination mt-5">{{ $counciling->links() }}</div>
        </div>
    </div>
        ...
        <div class="flex items-center justify-center min-h-screen px-4" @click.self="open = false">
            <div x-show="open" x-transition x-transition.duration.400 class="panel border-0 p-0 rounded-lg overflow-hidden w-full max-w-lg my-8">
                <div class="flex bg-[#fbfbfb] dark:bg-[#121c2c] items-center justify-between px-5 py-3">
                    ...
                    @else
                        <h5 class="font-bold text-lg text-blue-500">Add Counciling Person</h5>
                    @endif
                ...
                <div class="p-5 bg-gray-200 dark:bg-gray-800 text-left">
                    ...
                    >
                        <div class="mb-1">
                            <label for="Name" class="my-label">Person Name</label>
                            <input type="text" wire:model="name" placeholder="Counciling Person Name" id="Name" class="my-input focus:outline-none focus:shadow-outline">
                            @if ($errors->has('name'))
