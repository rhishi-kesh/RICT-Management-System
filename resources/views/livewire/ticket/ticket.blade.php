                ...
                <table class="w-full">
                    ...
                    <tbody>
                        @forelse ($tickets as $key => $ticket)
                            <tr class="cursor-pointer dark:hover:bg-slate-800 hover:bg-slate-50 transition-transform duration-300" x-on:click="window.location.href = '{{ route('ticketshow', $ticket->id) }}'">
