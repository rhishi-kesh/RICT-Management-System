<div class="pt-3">
    <div class="bg-white dark:bg-slate-900 shadow-md rounded px-4 md:px-5 pb-5">
        <div class="relative h-full">
            ...
            @if($ticket->status == 'open')
                <div class="w-full p-4 pb-0 dark:bg-slate-900">
                    <div class="w-full items-center space-x-3 space-x-reverse sm:flex">
                        <div class="relative flex-1 h-9 w-full flex">
                            <input id="" class="my-input focus:outline-none focus:shadow-outline h-full w-[calc(100%_-_50px)] shadow-none rounded-none" placeholder="Type a message" wire:model="message" @keyup.enter="$wire.call('sendMessage')">
                            <button type="button" class="absolute top-1/2 -translate-y-1/2 hover:text-blue-500 right-0 z-10 dark:bg-slate-700 bg-slate-100 border border-l-0 dark:border-gray-500 h-full w-[50px] flex justify-center items-center" @click="$wire.call('sendMessage')">
