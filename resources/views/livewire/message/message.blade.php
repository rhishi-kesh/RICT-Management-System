                ...
                <div class="w-full p-4 bg-blue-500">
                    <div class="w-full items-center space-x-3 space-x-reverse sm:flex">
                        <div class="relative flex-1 h-9 w-full flex">
                            <input id="" class="my-input focus:outline-none focus:shadow-none focus:border-none h-full w-[calc(100%_-_50px)] shadow-none rounded-none placeholder-black text-black" placeholder="Type a message" wire:model="message" @keyup.enter="$wire.call('sendMessage')">
