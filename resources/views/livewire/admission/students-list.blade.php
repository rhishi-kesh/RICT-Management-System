            ...
            <table class="w-full">
                <thead>
                    <tr>
                        ...
                        <th wire:click="doSort('student_id')" class="p-3 bg-gray-100 dark:bg-gray-800 text-center">
                            <x-datatable-item :sortColumn="$sortColumn" :sortDirection="$sortDirection" columnName="StudentID" />
                        </th>
                        <th wire:click="doSort('name')" class="p-3 bg-gray-100 dark:bg-gray-800 text-center">
                            <x-datatable-item :sortColumn="$sortColumn" :sortDirection="$sortDirection" columnName="Name" />
                        </th>
                        <th wire:click="doSort('fName')" class="p-3 bg-gray-100 dark:bg-gray-800 text-center">
                            <x-datatable-item :sortColumn="$sortColumn" :sortDirection="$sortDirection" columnName="FatherName" />
                        </th>
                        <th wire:click="doSort('mName')" class="p-3 bg-gray-100 dark:bg-gray-800 text-center">
                        ...
                        <th wire:click="doSort('address')" class="p-3 bg-gray-100 dark:bg-gray-800 text-center">
