<div class="pt-5">
    ...
    <form wire:submit="submit" class="bg-white dark:bg-slate-900 shadow-md rounded px-4 md:px-8 pt-6 pb-8 mb-4">
        <h2 class="mb-2 font-bold text-3xl dark:text-white text-blue-500">Edit Student Data</h2>
        <hr>
        ...
        <div class="mt-4">
            <button type="submit" class="btn-submit btn mr-3" wire:loading.remove>Update</button>
            <button type="button" disabled class="btn-submit btn mr-3" wire:loading>Loading</button>
            <a href="{{ route('studentsList') }}" type="button" class="btn btn-reset">Back</a>
        </div>
    </form>
    @push('js')
