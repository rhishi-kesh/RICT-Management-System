<div class="pt-5">
    ...
    <form wire:submit="submit" class="bg-white dark:bg-slate-900 shadow-md rounded px-4 md:px-8 pt-6 pb-8 mb-4">
        <h2 class="mb-2 font-bold text-3xl dark:text-white">Edit Student Data</h2>
        <hr>
        ...
        <div class="mt-4">
            ...
            <button type="button" disabled class="bg-blue-500 text-white border-blue-500 btn mr-3" wire:loading>Loading</button>
            <a href="{{ route('studentsList') }}" type="button" class="shadow btn bg-gray-900 dark:bg-white text-white dark:text-black uppercase border-white dark:border-black">back</a>
        </div>
    </form>
    @push('js')
