                        ...
                        @forelse ($users as $key => $data)
                            <tr class="border-b border-[#ebedf2] dark:border-[#191e3a]">
                                ...
                                <td class="p-3 flex justify-center">
                                    ...
                                    @else
                                        <img class="h-9 w-9 rounded-full object-cover saturate-50 group-hover:saturate-100" src="{{ asset('storage/' . $data->profile) }}" alt="image">
                                    @endif
                                </td>
                                <td class="p-3 text-center">{{ $data->name }}</td>
                                <td class="p-3 text-center">{{ $data->email }}</td>
                                <td class="p-3 text-center">{{ $data->mobile }}</td>
