            ...
            <table class="w-full">
                <thead>
                    <tr>
                        ...
                        <th class="p-3 bg-gray-100 dark:bg-gray-800 text-center">Slug</th>
            ...
            <div x-show="open" x-transition x-transition.duration.400 class="panel border-0 p-0 rounded-lg overflow-hidden w-full max-w-lg my-8">
                ...
                <div class="p-5 bg-gray-200 dark:bg-gray-800 text-left">
                    ...
                    >
                        ...
                        <div class="mb-1">
                            <label for="courseFee" class="my-label">Slug</label>
                            <input type="slug" wire:model="slug" placeholder="slug" id="slug"
