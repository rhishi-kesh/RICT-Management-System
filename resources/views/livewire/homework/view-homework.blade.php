        ...
        <div class="relative flex h-full gap-5 sm:h-[calc(100vh_-_150px)]">
            <div class="panel absolute z-10 hidden h-full w-[240px] max-w-full bg-white flex-none space-y-4 p-4 rounded-r-none xl:relative xl:block xl:h-auto xl:rounded-r-md" :class="{'!block':isShowTaskMenu}">
                <div class="flex h-full flex-col pb-16">
                    <div class="pb-2">
                        <div class="flex items-center text-center text-blue-500 font-bold">
                            <div class="shrink-0">
                            ...
                            <h3 class="text-lg ml-3">Home Work</h3>
                        </div>
                    </div>
                    ...
                    <div class="perfect-scrollbar relative -mr-3.5 h-full grow pr-3.5">
                        <div class="space-y-1">
                            <button type="button" class="flex h-10 w-full items-center justify-between rounded-md p-2 font-medium hover:bg-s hover:text-blue-500 hover:bg-gray-200 dark:hover:bg-[#181F32] dark:hover:text-primary hover:pl-3 duration-300" @click="activeTab = 'inbox'" :class="activeTab == 'inbox' ? 'bg-gray-100 dark:bg-[#181F32] text-blue-500' : ''">
                            ...
                            <button type="button" class="flex h-10 w-full items-center justify-between rounded-md p-2 font-medium hover:bg-s hover:text-blue-500 hover:bg-gray-200 dark:hover:bg-[#181F32] dark:hover:text-primary hover:pl-3 duration-300"  @click="activeTab = 'done'" :class="activeTab == 'done' ? 'bg-gray-100 dark:bg-[#181F32] text-blue-500' : ''">
                                <div class="flex items-center">
                            ...
                            <button type="button" class="flex h-10 w-full items-center justify-between rounded-md p-2 font-medium hover:bg-s hover:text-blue-500 hover:bg-gray-200 dark:hover:bg-[#181F32] dark:hover:text-primary hover:pl-3 duration-300" @click="activeTab = 'pending'" :class="activeTab == 'pending' ? 'bg-gray-100 dark:bg-[#181F32] text-blue-500' : ''">
                                <div class="flex items-center">
                            ...
                            <button type="button" class="flex h-10 w-full items-center justify-between rounded-md p-2 font-medium hover:bg-s hover:text-blue-500 hover:bg-gray-200 dark:hover:bg-[#181F32] dark:hover:text-primary hover:pl-3 duration-300" @click="activeTab = 'underProcessing'" :class="activeTab == 'underProcessing' ? 'bg-gray-100 dark:bg-[#181F32] text-blue-500' : ''">
                                <div class="flex items-center">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-3 w-3 shrink-0 rotate-45 fill-info" >
                                        <path d="M2 12C2 7.28595 2 4.92893 3.46447 3.46447C4.92893 2 7.28595 2 12 2C16.714 2 19.0711 2 20.5355 3.46447C22 4.92893 22 7.28595 22 12C22 16.714 22 19.0711 20.5355 20.5355C19.0711 22 16.714 22 12 22C7.28595 22 4.92893 22 3.46447 20.5355C2 19.0711 2 16.714 2 12Z" stroke="currentColor" stroke-width="1.5" />
                                    </svg>
                            ...
                            <button type="button" class="flex h-10 w-full items-center justify-between rounded-md p-2 font-medium hover:bg-s hover:text-blue-500 hover:bg-gray-200 dark:hover:bg-[#181F32] dark:hover:text-primary hover:pl-3 duration-300" @click="activeTab = 'inReview'" :class="activeTab == 'inReview' ? 'bg-gray-100 dark:bg-[#181F32] text-blue-500' : ''">
                                <div class="flex items-center">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-3 w-3 shrink-0 rotate-45 fill-info" >
                                        <path d="M2 12C2 7.28595 2 4.92893 3.46447 3.46447C4.92893 2 7.28595 2 12 2C16.714 2 19.0711 2 20.5355 3.46447C22 4.92893 22 7.28595 22 12C22 16.714 22 19.0711 20.5355 20.5355C19.0711 22 16.714 22 12 22C7.28595 22 4.92893 22 3.46447 20.5355C2 19.0711 2 16.714 2 12Z" stroke="currentColor" stroke-width="1.5" />
                                    </svg>
                            ...
                            <button type="button" class="flex h-10 w-full items-center justify-between rounded-md p-2 font-medium hover:bg-s hover:text-blue-500 hover:bg-gray-200 dark:hover:bg-[#181F32] dark:hover:text-primary hover:pl-3 duration-300" @click="activeTab = 'rejected'" :class="activeTab == 'rejected' ? 'bg-gray-100 dark:bg-[#181F32] text-blue-500' : ''">
                                <div class="flex items-center">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-3 w-3 shrink-0 rotate-45 fill-info" >
                                        <path d="M2 12C2 7.28595 2 4.92893 3.46447 3.46447C4.92893 2 7.28595 2 12 2C16.714 2 19.0711 2 20.5355 3.46447C22 4.92893 22 7.28595 22 12C22 16.714 22 19.0711 20.5355 20.5355C19.0711 22 16.714 22 12 22C7.28595 22 4.92893 22 3.46447 20.5355C2 19.0711 2 16.714 2 12Z" stroke="currentColor" stroke-width="1.5" />
                                    </svg>
            ...
            <div class="panel h-full flex-1 overflow-auto p-0 bg-white">
                <div class="flex h-full flex-col">
                    ...
                    <div x-show="activeTab == 'inbox'" class="table-responsive min-h-screen grow overflow-y-auto sm:min-h-[300px]">
                        <table class="table-hover w-full @if(count($allHomework) == 0) h-full @endif">
                            <thead>
                                @if(count($allHomework) !== 0)
                                    <tr>
                                        <th></th>
                                        <th></th>
                                        <th class="text-center py-3 font-bold text-blue-500">Status</th>
                                        <td class="text-center pt-4 font-bold text-blue-500">Dateline</td>
                                        <td class="text-center pt-4 font-bold text-blue-500">Action</td>
                                    </tr>
                                @endif
                            </thead>
                            <tbody>
                                    ...
                                    <tr class="group hover:bg-[#EBEBEB] dark:hover:bg-[#121E31] border-b dark:border-b-[#181F32] border-b-[#EBEBEB]">
                                        <td class="px-5 py-2 w-[80px]">
                                            @if (empty($item->student->profile))
                                                <div class="profile w-9 h-9 text-xs">{{ mb_substr(strtoupper($item->student->nam ?? 'N/A'), 0, 1) }}
                                                </div>
                                            @else
                                                <div class="text-center">
                                                    <img class="w-9 h-9 rounded-full overflow-hidden object-cover ring-2 ring-blue dark:ring-[#515365] shadow-[0_0_15px_1px_rgba(113,106,202,0.30)] dark:shadow-none" src="{{ asset('storage/' . $item->student->profile ?? 'profile.jpeg') }}" alt="img" width="150" height="100" />
                                                </div>
                                            @endif
                                        </td>
                                        ...
                                        <td class="px-5 py-2 flex justify-center">
                                            <div>
                                        ...
                                        <td class="px-5 py-2 flex justify-center h-full items-center">
                    ...
                    <div x-show="activeTab == 'done'" class="table-responsive min-h-screen grow overflow-y-auto sm:min-h-[300px]">
                        <table class="table-hover w-full @if(count($doneHomework) == 0) h-full @endif">
                            <thead>
                                @if(count($doneHomework) !== 0)
                                    <tr>
                                        <th></th>
                                        <th></th>
                                        <th class="text-center py-3 font-bold text-blue-500">Status</th>
                            ...
                            <tbody>
                                @forelse ($doneHomework as $item)
                                    <tr class="group hover:bg-[#EBEBEB] dark:hover:bg-[#121E31] border-b dark:border-b-[#181F32] border-b-[#EBEBEB]">
                                        ...
                                        <td class="px-5 py-2 flex justify-center items-center">
                                            <div class="flex w-max items-center justify-between">
                                                <div x-data="dropdown" @click.outside="open = false" class="dropdown">
                                                    <button type="button" @click="toggle">
                                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 rotate-90 opacity-70" >
                    ...
                    <div x-show="activeTab == 'pending'" class="table-responsive min-h-screen grow overflow-y-auto sm:min-h-[300px]">
                        <table class="table-hover w-full @if(count($pendingHomework) == 0) h-full @endif">
                            <thead>
                                @if(count($pendingHomework) !== 0)
                                    <tr>
                                        <th></th>
                                        <th></th>
                                        <th class="text-center py-3 font-bold text-blue-500">Status</th>
                    ...
                    <div x-show="activeTab == 'underProcessing'" class="table-responsive min-h-screen grow overflow-y-auto sm:min-h-[300px]">
                        <table class="table-hover w-full @if(count($underProcessingHomework) == 0) h-full @endif">
                            <thead>
                                @if(count($underProcessingHomework) !== 0)
                                    <tr>
                                        <th></th>
                                        <th></th>
                                        <th class="text-center py-3 font-bold text-blue-500">Status</th>
                    ...
                    <div x-show="activeTab == 'inReview'" class="table-responsive min-h-screen grow overflow-y-auto sm:min-h-[300px]">
                        <table class="table-hover w-full @if(count($inReviewHomework) == 0) h-full @endif">
                            <thead>
                                @if(count($inReviewHomework) !== 0)
                                    <tr>
                                        <th></th>
                                        <th></th>
                                        <th class="text-center py-3 font-bold text-blue-500">Status</th>
                    ...
                    <div x-show="activeTab == 'rejected'" class="table-responsive min-h-screen grow overflow-y-auto sm:min-h-[300px]">
                        <table class="table-hover w-full @if(count($rejectHomework) == 0) h-full @endif">
                            <thead>
                                @if(count($rejectHomework) !== 0)
                                    <tr>
                                        <th></th>
                                        <th></th>
                                        <th class="text-center py-3 font-bold text-blue-500">Status</th>
            ...
            <div class="fixed inset-0 bg-[black]/60 z-[999] hidden overflow-y-auto" :class="modalOpen && '!block'">
                <div class="flex items-center justify-center min-h-screen px-4" @click.self="modalOpen = false">
                    <div x-show="modalOpen" x-transition x-transition.duration.400 class="panel border-0 p-0 rounded-lg overflow-hidden w-full max-w-lg my-8">
                        <div class="flex bg-[#fbfbfb] dark:bg-[#121c2c] items-center justify-between px-5 py-3">
                            <h5 class="font-bold text-lg text-blue-500">Edit Homework</h5>
