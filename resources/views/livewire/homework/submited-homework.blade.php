            ...
            <div class="panel absolute z-10 hidden h-full w-[240px] max-w-full flex-none space-y-4 p-4 rounded-r-none xl:relative xl:block xl:h-auto xl:rounded-r-md bg-white" :class="{'!block':isShowTaskMenu}">
                <div class="flex h-full flex-col pb-16">
                    ...
                    <div class="perfect-scrollbar relative -mr-3.5 h-full grow pr-3.5">
                        <div class="space-y-1">
                            <button type="button" class="flex h-10 w-full items-center justify-between rounded-md p-2 font-medium hover:bg-s hover:text-blue-500 hover:bg-gray-200 dark:hover:bg-[#181F32] dark:hover:text-primary hover:pl-3 duration-300" @click="activeTab = 'inbox'" :class="activeTab == 'inbox' ? 'bg-gray-200 dark:bg-[#181F32] text-blue-500' : ''">
                                ...
                                @forelse ($allHomework as $item)
                                    <tr class="group hover:bg-[#EBEBEB] dark:hover:bg-[#121E31] border-b dark:border-b-[#181F32] border-b-[#EBEBEB]">
                                        ...
                                        <td class="p-5 pl-0">
                                            <p class="whitespace-nowrap text-base font-semibold group-hover:text-blue-500 line-clamp-1 min-w-[50px] cursor-pointer">
                                                <span>
                                                    ...
                                                    <span class="ml-2 inline-block whitespace-nowrap px-2 py-[.120rem] rounded-full capitalize hover:bg-blue-500 hover:text-white text-xs border border-blue-500 select-none">{{ $item->created_at->diffForHumans() }}</span>
                                                </span>
                                        ...
                                        <td class="p-5 text-center">
                                            ...
                                            <div class="mt-2 flex gap-2 justify-center items-center" x-show="editStatus == {{ $item->id }}">
                                                <select wire:model="status" class="my-input w-[200px] focus:outline-none focus:shadow-outline text-black dark:text-white">
                                        ...
                                        <td class="p-5 flex justify-center">
                                            <button x-tooltip="Show Homework" class="bg-blue-500 btn text-white border-0 flex items-center justify-between" @click="viewHomework = true; $wire.call('viewHomeWork','{{ $item->id }}')">
                                                ...
                                                <span class="ml-2 text-nowrap">Submitd Homework</span>
                                            </button>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
                                        <td colspan="20">
                                            <div class="flex justify-center items-center">
                                                <img src="{{ asset('empty.png') }}" alt="" class="w-[200px] md:w-[350px] opacity-40 dark:opacity-15 mt-10 select-none">
                                            </div>
                                        </td>
                                    </tr>
                                @endforelse
            ...
            <div class="fixed inset-0 bg-[black]/60 z-[999] hidden overflow-y-auto" :class="viewHomework && '!block'">
                <div class="flex items-center justify-center min-h-screen px-4" @click.self="viewHomework = false">
                    <div x-show="viewHomework" x-transition x-transition.duration.400 class="panel border-0 p-0 rounded-lg overflow-hidden w-full max-w-lg my-8">
                        <div class="flex bg-[#fbfbfb] dark:bg-[#121c2c] items-center justify-between px-5 py-3">
                            <h5 class="font-bold text-lg">Submited Task</h5>
                        ...
                        <div class="p-5 bg-gray-200 dark:bg-gray-800 text-left">
                            <p>
                                <b>Task Url:</b>
                                <a href="{{ $singleHomework->url ?? 'Loading...' }}" class="text-blue-500 inline-block mb-4" target="_blank">{{ $singleHomework->url ?? 'Loading...' }}</a>
                            </p>
            ...
            <div class="fixed inset-0 bg-[black]/60 z-[999] hidden overflow-y-auto" :class="modalOpen && '!block'">
                <div class="flex items-center justify-center min-h-screen px-4" @click.self="modalOpen = false">
                    <div x-show="modalOpen" x-transition x-transition.duration.400 class="panel border-0 p-0 rounded-lg overflow-hidden w-full max-w-lg my-8">
                        <div class="flex bg-[#fbfbfb] dark:bg-[#121c2c] items-center justify-between px-5 py-3">
                            <h5 class="font-bold text-lg text-blue-500">Give Feedback</h5>
                        ...
                        <div class="p-5 bg-gray-200 dark:bg-gray-800 text-left">
                            ...
                            >
                                <div>
                                    <label for="feedbback" class="my-label">Your Feedback</label>
                                    <textarea name="feedback" wire:model="feedback" id="feedback" rows="7" placeholder="Enter Feedback" class="@error('text') is-invalid @enderror my-input focus:outline-none focus:shadow-outline"></textarea>
                                    @error('feedback')
