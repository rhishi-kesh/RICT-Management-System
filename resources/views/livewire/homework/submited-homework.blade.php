                                    ...
                                    <tr class="group hover:bg-[#F9FAFB] dark:hover:bg-[#121E31] border-b border-b-[#121E31]">
                                        ...
                                        <td class="p-5 text-center">
                                            ...
                                            <div class="mt-2 flex gap-2 justify-between items-center" x-show="editStatus == {{ $item->id }}">
                                                <select wire:model="status" class="my-input w-[100px] md:w-full focus:outline-none focus:shadow-outline text-white @if($item->status == 'done') dark:bg-green-500 bg-green-500 @elseif($item->status == 'reject') dark:bg-red-500 bg-red-500 @endif">
